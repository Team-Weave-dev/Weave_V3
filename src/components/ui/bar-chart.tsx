  ...
  "w-full h-full",
  {
    variants: {
      variant: {
        ...
        gradient: "fill-gradient-to-br from-primary to-primary/60",
        subtle: "fill-muted-foreground/80"
      },
      animation: {
        none: "",
...
const BarChart = React.forwardRef<HTMLDivElement, BarChartProps>(
  ({
    ...
    xAxisKey = "name",
    color,
    radius = chartTypes.bar.defaultRadius,
    showGrid = true,
    showAxis = true,
    showTooltip = true,
    showLegend = false,
    ...
    return (
      <Chart ref={ref} {...chartProps}>
        <ChartContent className={cn(barChartVariants({ variant, animation }), className)}>
            ...
            >
              ...
              {dataKeys.map((key, index) => (
                <Bar
                  ...
                  fillOpacity={chartTypes.bar.fillOpacity}
